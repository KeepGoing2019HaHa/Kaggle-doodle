import os
os.environ['CUDA_VISIBLE_DEVICES'] =  '0,1,2,3,4,5,6,7' #'3,2,1,0'
...
def valid_augment(drawing, label, index):
    ...
    # image = drawing_to_image(drawing, 96, 96)
...
def run_train():
    ...
    fold    = 0
    out_dir = \
        '/datanew/DATASET/doodle/results/2018-11-12/34-224-baseline'
    initial_checkpoint = \
        None

    pretrain_file = \
        '/data/yiwei/.torch/models/resnet34-333f7ec4.pth'
        # None
        # '/coer/yiwei/kaggle/doodle/results/resnet34-fold1/checkpoint/00038000_model.pth'


    # schduler  = NullScheduler(lr=0.01)
    schduler = DecayScheduler(base_lr=0.01, decay=0.99, step=300) # 0.99^600=0.0024, 300*600=180k
    # schduler = CyclicScheduler(min_lr=0.0001, max_lr=0.01, period=300., warm_start=5)
    iter_save_interval = 20000 #2000
    ...
    batch_size = 72*8 # 160  # 256  # 256 # 512 # 128  #16 #32
