...
def run_test_fold():
    ...
    configures =[
         Struct(
            split        = '<NIL>', #'valid_0', #
            out_test_dir = '/coer/yiwei/kaggle/doodle/results/resnet34-fold6/test',
            checkpoint   = '/coer/yiwei/kaggle/doodle/results/resnet34-fold6/checkpoint/00100000_model.pth',
         ),
    ]
    ...
    for configure in configures:
        ...
        csv_file = out_test_dir + '/%s-%s.submit.csv'%(mode,augment)
