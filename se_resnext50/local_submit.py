...
def run_test_fold():
    ...
    configures =[
         # Struct(
         #    split        = '<NIL>', # '<NIL>', #'valid_0', # 'train_0'
         #    out_test_dir = '/datanew/DATASET/doodle/results/2018-11-24/test',
         #    checkpoint   = '/datanew/DATASET/doodle/results/2018-11-24/checkpoint/00336000_model.pth',
         # ),
        # Struct(
        #     split        = '<NIL>', # '<NIL>', #'valid_0', # 'train_0'
        #     out_test_dir = '/datanew/DATASET/doodle/results/2018-11-24/test',
        #     checkpoint   = '/datanew/DATASET/doodle/results/2018-11-24/checkpoint/00334000_model.pth',
        #  ),
        # Struct(
        #     split        = '<NIL>', # '<NIL>', #'valid_0', # 'train_0'
        #     out_test_dir = '/datanew/DATASET/doodle/results/2018-11-24/test',
        #     checkpoint   = '/datanew/DATASET/doodle/results/2018-11-24/checkpoint/00332000_model.pth',
        #  ),
        Struct(
            split        = '<NIL>', # '<NIL>', #'valid_0', # 'train_0'
            out_test_dir = '/datanew/DATASET/doodle/results/2018-12-1/test',
            checkpoint   = '/datanew/DATASET/doodle/results/2018-12-1/checkpoint/00326000_model.pth',
         ),
    ]
    ...
    for configure in configures:
        ...
        steps        = checkpoint[-16:-13]+'k'
        
        # for augment in ['null', 'flip']:
        # for augment in ['null']:
        for augment in ['flip']:
        # for augment in ['drop']:
            npy_file = out_test_dir + '/%s-%s-%s.prob.uint8.npy'%(mode,steps,augment)
            csv_file = out_test_dir + '/%s-%s-%s.submit.csv'%(mode,steps,augment)
