...
def run_train():
    ...
    fold    = 0
    out_dir = \
        '/datanew/DATASET/doodle/results/2018-12-1'
    initial_checkpoint = \
        '/datanew/DATASET/doodle/results/2018-12-1/checkpoint/00285000_model.pth'
        # None

    pretrain_file = \
        None
        # '/data/yiwei/.torch/models/se_resnext50_32x4d-a260b3a4.pth'
        # '/coer/yiwei/kaggle/doodle/results/resnet34-fold1/checkpoint/00038000_model.pth'


    # schduler  = NullScheduler(lr=0.01)
    schduler = DecayScheduler(base_lr=0.01, decay=0.99, step=800)
    iter_save_interval = 20000//10
