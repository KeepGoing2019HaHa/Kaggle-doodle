...
def run_train():
    ...
    fold    = 0
    out_dir = \
        '/datanew/DATASET/doodle/results/2018-11-12/224-baseline'
    initial_checkpoint = \
        None
        # '/datanew/DATASET/doodle/results/2018-11-12/128-baseline/checkpoint/00200000_model.pth'
        # None
    ...
    schduler = DecayScheduler(base_lr=0.01, decay=0.99, step=700) #400*2 #400-->batch 512
    iter_save_interval = 20000//4
