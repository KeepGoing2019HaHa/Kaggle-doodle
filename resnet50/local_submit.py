...
def run_test_fold():
    ...
    configures =[
         Struct(
            split        = '<NIL>', #'valid_0', #
            out_test_dir = '/datanew/DATASET/doodle/results/2018-11-12/128-baseline-8/test/',
            checkpoint   = '/datanew/DATASET/doodle/results/2018-11-12/128-baseline-8/checkpoint/00320000_model.pth',
         ),
    ]
    ...
    for configure in configures:
        ...
        npy_file = out_test_dir + '/%s-%s-%s.prob.uint8.npy'%(mode,augment,iteration)
        csv_file = out_test_dir + '/%s-%s-%s.submit.csv'%(mode,augment,iteration)
