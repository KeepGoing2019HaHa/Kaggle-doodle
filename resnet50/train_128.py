import os
os.environ['CUDA_VISIBLE_DEVICES'] =  '0,1,2,3,4,5,6,7' #'0,1,2,3,4,5' #'3,2,1,0'
...
def valid_augment(drawing, label, index):
    ...
    # image = drawing_to_image(drawing, 224, 224)
...
def run_train():
    ...
    fold    = 0
    out_dir = \
        '/datanew/DATASET/doodle/results/2018-11-12/128-0.9-cudnn_disabled'
    initial_checkpoint = \
        None
        # '/datanew/DATASET/doodle/results/2018-11-12/128-0.9/checkpoint/00080000_model.pth'
        # '/datanew/DATASET/doodle/results/2018-11-12/128-baseline/checkpoint/00240000_model.pth'
        # None
        # '/coer/yiwei/kaggle/doodle/results-cnn-11-08/0-baseline/checkpoint/00060000_model.pth'
        # None

    pretrain_file = \
        '/data/yiwei/.torch/models/resnet50-19c8e357.pth'
        # None
        # '/home/yw/.torch/models/resnet50-19c8e357.pth'
        # '/coer/yiwei/kaggle/doodle/results/resnet34-fold1/checkpoint/00038000_model.pth'


    # schduler  = NullScheduler(lr=0.01)
    schduler = DecayScheduler(base_lr=0.01, decay=0.99, step=400*2) #400-->batch 512
    iter_save_interval = 20000
